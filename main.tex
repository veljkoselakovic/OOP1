...
\title{OOP1\\\large Objektno-orijenitsano programiranje 1}
...
Nebitno da li su slovne ili sam nesto pogresno lupio. Mozete i sami izmeniti na https://github.com/veljkoselakovic/OOP1-skripta i napraviti pull request
\newpage
...
\begin{itemize}
    ...
    \item Može biti preklopljen $\backslash$ \textit{overloadoded}
\end{itemize}
